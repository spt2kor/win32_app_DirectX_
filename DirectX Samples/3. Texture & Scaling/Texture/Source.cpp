...
bool InitScene()
{
    ...
    sampDesc.Filter = D3D11_FILTER_MIN_MAG_MIP_LINEAR; // Method to use for minification and magnification
	// Identify a technique for resolving texture coordinates that are outside of the boundaries of a texture.
    sampDesc.AddressU = D3D11_TEXTURE_ADDRESS_MIRROR; // for u values between 0 and 3, the texture is repeated three times.
    sampDesc.AddressV = D3D11_TEXTURE_ADDRESS_MIRROR;
    sampDesc.AddressW = D3D11_TEXTURE_ADDRESS_MIRROR;
    sampDesc.ComparisonFunc = D3D11_COMPARISON_NEVER; // Comparison of source and destination data
    sampDesc.MinLOD = 0;  // Lower end of the mipmap range
    sampDesc.MaxLOD = D3D11_FLOAT32_MAX; // Upper end of the mipmap range
